...
interface ProductProps {
  ...
  colorImages: string;
  onAddtoCart: () => void;
  onBuyLoading: boolean;
  onCartLoading: boolean;
 ...
 useEffect(() => {
  ...
  return (
    <div className="flex flex-col mt-2 space-y-1 pb-10 md:mt-0 md:mx-4 md:w-[50%]">
      ...
      <button
          onClick={onBuyNow}
          className={`w-[80%] bg-gray-800 text-white rounded-full py-2 hover:bg-black hover:text-white md:w-52 ${ onBuyLoading
            ? "opacity-80 cursor-not-allowed hover:bg-black hover:text-white"
            : ""}`}
            disabled={onBuyLoading}
        >
        ...
        <button
          onClick={onAddtoCart}
          className={`border-2 border-black w-[80%] rounded-full py-2 hover:bg-black hover:text-white md:w-52 ${ onCartLoading
            ? "opacity-80 cursor-not-allowed hover:bg-black hover:text-white"
            : ""}`}
