...
function BenefitsOfSore() {
  return (
    <div className="pb-24 flex flex-col justify-center space-y-3">
      ...
      <div className="flex flex-wrap justify-center gap-5">
       <Benifits icon={<FaTruckArrowRight/>} benefit="Fastest and Free of cost delivery in any corner of world!"/>
       <Benifits icon={<MdWorkspacePremium />} benefit="Most affordable and premium quality of products"/>
       <Benifits icon={<MdDiscount/>} benefit="Discounts upto 70% on every item!"/>
      </div>
    </div>
  );
}
