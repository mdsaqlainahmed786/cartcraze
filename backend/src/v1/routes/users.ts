...
userRouter.get("/verify/:token", async (req: Request, res: Response) => {
    ...
    try {
        ...
        res.cookie("Secret_Auth_token", newToken, { maxAge: 24 * 60 * 60 * 1000, sameSite: "none", secure:true});
...
userRouter.post("/signin", async (req: Request, res: Response) => {
    ...
    try {
        ...
        res.cookie("Secret_Auth_token", token, { maxAge: 24 * 60 * 60 * 1000, sameSite: "none", secure:true });
        res.status(200).json({
